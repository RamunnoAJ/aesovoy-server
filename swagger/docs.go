...
const docTemplate = `{
        ...
        "/api/v1/expenses": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Type (local/production)",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/invoices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by date string",
                        "name": "date",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.InvoicesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "api.InvoicesResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/billing.InvoiceFile"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/api.InvoicesMeta"
                }
            }
        },
        ...
        "store.Expense": {
            ...
            "properties": {
                "amount": {
                    "description": "stored as NUMERIC, transferred as string",
                    "type": "string"
                },
                "category_id": {
                    "type": "integer"
                ...
                "type": {
                    "$ref": "#/definitions/store.ExpenseType"
                }
            }
        },
        "store.ExpenseType": {
